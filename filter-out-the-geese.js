...
//My solution
//birds is the arguement
function gooseFilter (birds) {
    //geese is the list containting strings with same elements
    var geese = ["African", "Roman Tufted", "Toulouse", "Pilgrim", "Steinbacher"];
  //filter method copys a portion of the array
    //includes method shows wether array includes certain value true or false
  return birds.filter(b => !geese.include(b))
